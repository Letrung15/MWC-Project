...
using Common;
using LTShops.Models;
//using LTShops.Models.AddressModel;

namespace LTShops.Controllers
{
    public class UserController : Controller
    {
        ...
        public void SendVerificationLinkEmail(string email, string activationCode, string emailFor = "VerifyAccount")
        {
            ...
            //var fromEmail = new MailAddress(ConfigurationManager.AppSettings["FromEmailAddress"], "LTShops");
